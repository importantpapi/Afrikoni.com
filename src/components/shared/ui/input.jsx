    ...
    <input
      ...
      className={cn(
        ...
        error 
          ...
          : 'border-afrikoni-gold/30 dark:border-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-afrikoni-gold focus-visible:ring-offset-2',
        className
      )}
      ref={ref}
      {...props}
