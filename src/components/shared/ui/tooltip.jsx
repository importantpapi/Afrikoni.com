        ...
        <AnimatePresence>
          {isVisible && (
            <motion.div
              ...
              className={cn(
                'px-4 py-2.5 text-os-xs font-semibold text-white bg-afrikoni-chestnut rounded-os-sm shadow-2xl whitespace-nowrap border-2 border-os-accent/30 backdrop-blur-sm',
                className
              )}
            >
              {content}
