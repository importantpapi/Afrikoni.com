    ...
    <Surface variant="panel" className="p-5 h-full">
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Operational intelligence to unblock flows</p>
        </div>
        <Sparkles className="h-5 w-5 text-primary" />
      </div>
      <div className="space-y-3">
        {loading && <p className="text-xs text-muted-foreground">Scanning trades…</p>}
