...
const ControlPlaneMetric = ({ icon: Icon, label, value, max, status, tooltip, onClick }) => {
    ...
    return (
        ...
        >
            ...
            {/* Label */}
            <div className="text-os-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
                {label}
            </div>
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-bold text-os-sm text-gray-900">{blocker.title}</h4>
                        <Badge variant={blocker.severity === 'critical' ? 'destructive' : 'warning'}>
                            {blocker.severity}
                        </Badge>
                    </div>

                    <p className="text-os-xs text-gray-700 mb-2">{blocker.description}</p>

                    <div className="flex items-center justify-between">
                        <div className="text-os-xs text-gray-600">
...
export const ControlPlaneDashboard = ({ systemState }) => {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div>
                <h2 className="text-os-2xl font-bold text-afrikoni-deep mb-2">
                    System Health Center
                </h2>
                <p className="text-os-sm text-gray-600">
                    Real-time check of your business infrastructure
                </p>
            </div>
            ...
            <Surface className="p-6 border border-os-accent/10">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-os-xs text-gray-500">
                            Overall health of your trade setup
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative w-20 h-20">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className="text-os-2xl font-bold text-afrikoni-deep">
                            ...
                            <Badge variant={
                                tradeReadiness.status === 'ready' ? 'success' :
                                    tradeReadiness.status === 'warning' ? 'warning' :
                                        'destructive'
                            } className="text-os-sm px-3 py-1">
                ...
                <div className="grid grid-cols-4 gap-3">
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-os-xs text-gray-500 mb-1">Trust</div>
                        <div className="text-os-lg font-bold text-afrikoni-deep">
                            {tradeReadiness.components.trust}
                        </div>
                    </div>
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-os-xs text-gray-500 mb-1">Compliance</div>
                        <div className="text-os-lg font-bold text-afrikoni-deep">
                            {tradeReadiness.components.compliance}
                        </div>
                    </div>
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-os-xs text-gray-500 mb-1">Financial</div>
                        <div className="text-os-lg font-bold text-afrikoni-deep">
                            {tradeReadiness.components.financial}
                        </div>
                    </div>
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-os-xs text-gray-500 mb-1">Logistics</div>
                        <div className="text-os-lg font-bold text-afrikoni-deep">
            ...
            <div className="grid grid-cols-4 gap-4">
                <ControlPlaneMetric
                    ...
                    tooltip="Based on your identity check and business history"
                ...
                <ControlPlaneMetric
                    ...
                    tooltip="Real-time health of your shipping corridors"
                ...
                <ControlPlaneMetric
                    ...
                    tooltip="Safety level of your pending payments"
            ...
            {intelligence.recommendations.length > 0 && (
                <Surface className="p-6">
                    ...
                    <div className="text-os-sm text-gray-600">
