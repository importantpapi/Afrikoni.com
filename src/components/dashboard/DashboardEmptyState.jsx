...
export default function DashboardEmptyState() {
    ...
    return (
        <Surface variant="glass" className="p-8 md:p-12 border border-afrikoni-gold/20 relative overflow-hidden text-center">
            {/* Background Ambience */}
            <div className="absolute inset-0 bg-gradient-to-b from-afrikoni-gold/5 to-transparent pointer-events-none" />
            ...
            <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#D4A937] to-[#B08920] flex items-center justify-center mb-6 shadow-[0_10px_30px_rgba(212,169,55,0.3)]">
                    <LayoutDashboard className="w-8 h-8 text-white" />
                </div>

                <h2 className="text-2xl md:text-3xl font-light text-[var(--os-text-primary)] mb-3">
                ...
                <div className="grid md:grid-cols-3 gap-4 w-full text-left">
                    ...
                    <button
                        ...
                        className="group p-5 rounded-xl border border-afrikoni-gold/20 bg-white/5 hover:bg-afrikoni-gold/10 transition-all hover:scale-[1.02] hover:shadow-lg"
                    >
                        ...
                        <p className="text-xs text-os-muted">Draft a specialized RFQ for cocoa, coffee, or minerals.</p>
                    </button>

                    {/* Action 2: Seller Flow */}
                    <button
                        onClick={() => navigate('/dashboard/products/new')}
                        className="group p-5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all hover:scale-[1.02]"
                    >
                        ...
                        <p className="text-xs text-os-muted">List your inventory to global buyers.</p>
                    </button>
                    ...
                    >
                        ...
                        <p className="text-xs text-os-muted">Analyze live corridor data and tariffs.</p>
                    </button>
                </div>

                <div className="mt-10 flex items-center gap-2 text-xs text-os-muted">
