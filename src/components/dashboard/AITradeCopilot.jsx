      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-6 z-[9990] w-[360px] max-h-[500px] bg-white dark:bg-[#0F0F0F] border border-gray-200 dark:border-[#2A2A2A] rounded-2xl shadow-2xl shadow-black/10 dark:shadow-black/50 overflow-hidden flex flex-col"
          >
            {/* Header */}
            <div className="px-4 py-3 border-b border-gray-200 dark:border-[#1E1E1E] flex items-center gap-2">
              ...
              <div className="flex-1">
                <span className="text-sm font-semibold text-gray-900 dark:text-[#F5F0E8]">AI Trade Copilot</span>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {/* AI Insights */}
              <div className="p-3 rounded-xl bg-gray-50 dark:bg-[#141414] border border-gray-200 dark:border-[#1E1E1E]">
                ...
                <p className="text-[13px] text-gray-600 dark:text-gray-300 leading-relaxed">
                  Your trust score is <span className="text-emerald-600 dark:text-emerald-400 font-semibold">78</span>. Complete supplier verification to unlock premium buyer access and faster escrow releases.
                </p>
              </div>
                ...
                <div className="mt-2 space-y-1.5">
                  {SUGGESTIONS.map((suggestion, i) => (
                    <motion.a
                      ...
                      className="flex items-center gap-2 p-2.5 rounded-lg bg-gray-50 dark:bg-[#1A1A1A] hover:bg-gray-100 dark:hover:bg-[#222] border border-transparent hover:border-[#D4A937]/20 transition-all group"
                    >
                      <ChevronRight className="w-3 h-3 text-gray-400 dark:text-gray-600 group-hover:text-[#D4A937] transition-colors" />
            ...
            <div className="p-3 border-t border-gray-200 dark:border-[#1E1E1E]">
              <div className="flex items-center gap-2 bg-gray-50 dark:bg-[#141414] rounded-xl px-3 py-2 border border-gray-200 dark:border-[#2A2A2A] focus-within:border-[#D4A937]/30 transition-colors">
                <input
                  value={input}
