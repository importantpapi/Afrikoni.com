    ...
    <Card className={`border-gray-200 dark:border-[#1E1E1E] bg-white dark:bg-[#141414] rounded-os-sm ${className}`}>
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <Badge className="dark:bg-emerald-950/30 dark:text-emerald-400 border dark:border-emerald-900/30 text-os-xs font-semibold">
            Active
          </Badge>
        </div>
      </CardHeader>
      <CardContent>
        ...
        <div className="grid grid-cols-3 gap-3 mb-5">
          <div className="text-center p-2 rounded-lg dark:bg-[#1A1A1A]">
            <div className="flex items-center justify-center gap-1 text-os-xs dark:text-gray-400 mb-1 font-medium uppercase tracking-wider">
              <DollarSign className="w-3 h-3" /> Total
            </div>
            <p className="text-os-base font-bold font-mono dark:text-[#F5F0E8]">
              ${totalAmount.toLocaleString()}
            </p>
          </div>
          <div className="text-center p-2 rounded-lg dark:bg-emerald-950/20">
            <div className="text-os-xs dark:text-emerald-400 font-medium mb-1 uppercase tracking-wider">Released</div>
            <p className="text-os-base font-bold font-mono dark:text-emerald-400">
              ${releasedAmount.toLocaleString()}
            </p>
          </div>
          <div className="text-center p-2 rounded-lg">
            <div className="flex items-center justify-center gap-1 text-os-xs font-medium mb-1 uppercase tracking-wider">
              <Clock className="w-3 h-3" /> Held
            </div>
            <p className="text-os-base font-bold font-mono">
        ...
        <div className="mb-5">
          <div className="flex justify-between text-os-xs dark:text-gray-400 mb-1.5 font-medium">
              ...
              >
                <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 ${
                  ...
                  {status === 'completed' ? (
                    ...
                    <span className="text-os-xs font-bold">{i + 1}</span>
                  )}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-os-xs dark:text-gray-400">
