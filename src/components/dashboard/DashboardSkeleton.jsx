...
export default function DashboardSkeleton() {
    return (
        <div className="os-page space-y-6 opacity-50">
            {/* 1. Header Area */}
            ...
            {/* Status Bar */}
            <Surface variant="panel" className="p-4 border border-os-stroke/50">
            ...
            {/* Today's Actions */}
            <Surface variant="panel" className="p-6 border border-os-stroke/50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[1, 2, 3, 4].map((i) => (
                    <Surface key={i} variant="panel" className="p-5 h-[140px] border border-white/5">
            ...
            <div className="grid lg:grid-cols-3 gap-6 h-auto min-h-[400px]">
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                    <Surface variant="panel" className="p-6 h-[200px] border border-white/5">
                ...
                <div className="flex flex-col gap-6">
                    <Surface variant="panel" className="p-5 h-[300px] border border-white/5">
