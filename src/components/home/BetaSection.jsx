...
export default function BetaSection() {
  return (
    <section className="py-12 md:py-16 bg-gradient-to-br from-os-accent/10 via-afrikoni-chestnut/10 to-os-accent/10">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-os-accent/20 border border-os-accent/40 rounded-full px-4 py-2 mb-4">
            <Sparkles className="w-4 h-4 text-os-accent" />
            <span className="text-os-sm font-semibold text-afrikoni-chestnut">BETA LIVE</span>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          >
            <Card className="border-os-accent/30 bg-afrikoni-cream/50">
              <CardContent className="p-6 text-center">
                <Target className="w-8 h-8 text-os-accent mx-auto mb-3" />
          ...
          >
            <Card className="border-os-accent/30 bg-afrikoni-cream/50">
              <CardContent className="p-6 text-center">
                <Shield className="w-8 h-8 text-os-accent mx-auto mb-3" />
          ...
          >
            <Card className="border-os-accent/30 bg-afrikoni-cream/50">
              <CardContent className="p-6 text-center">
                <CheckCircle className="w-8 h-8 text-os-accent mx-auto mb-3" />
