    ...
    <div id="how-it-works" className="py-12 md:py-16 bg-afrikoni-offwhite">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-12 md:mb-16">
          ...
          >
            <span className="text-green-600 font-semibold text-os-base md:text-os-lg">For Buyers</span>
            <h3 className="text-os-2xl md:text-3xl font-bold text-afrikoni-chestnut mt-2">Source Products in 3 Simple Steps</h3>
          </motion.div>
            ...
            {buyerSteps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Card className="border-os-accent/20 relative overflow-hidden hover:shadow-2xl transition-all rounded-os-sm">
                      ...
                      <CardContent className="p-6 md:p-8 relative">
                        ...
                        <h4 className="text-os-lg md:text-os-xl font-bold text-afrikoni-chestnut mb-3">{step.title}</h4>
                        <p className="text-os-sm md:text-os-base text-afrikoni-deep mb-5 md:mb-6">{step.description}</p>
                        <ul className="space-y-2">
                          {step.features.map((feature, fIdx) => (
                            <li key={fIdx} className="flex items-center gap-2 text-os-xs md:text-os-sm text-afrikoni-deep">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link to={createPageUrl('BuyerCentral')}>
                <Button className="bg-os-accent hover:bg-os-accentDark text-afrikoni-creampx-6 md:px-8 py-2.5 md:py-3 rounded-lg font-semibold shadow-os-md hover:shadow-os-lg transition-shadow">
                  Start Sourcing Now →
                </Button>
              </Link>
            </motion.div>
        ...
        <div>
          <motion.div 
            ...
            className="mb-6 md:mb-8"
          >
            <span className="text-green-600 font-semibold text-os-base md:text-os-lg">For Sellers</span>
            <h3 className="text-os-2xl md:text-3xl font-bold text-afrikoni-chestnut mt-2">Grow Your Business in 3 Steps</h3>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link to={createPageUrl('SellerOnboarding')}>
                <Button className="bg-green-600 hover:bg-green-700 text-afrikoni-creampx-6 md:px-8 py-2.5 md:py-3 rounded-lg font-semibold shadow-os-md hover:shadow-os-lg transition-shadow">
                  Start Selling Now →
                </Button>
              </Link>
            </motion.div>
