...
export default function SystemAdvice({ advice, type = 'opportunity', onAction }) {
    ...
    return (
        <div className="relative group overflow-hidden rounded-xl border border-white/10 bg-black/40 backdrop-blur-md p-4 transition-all hover:border-koni-gold/30">
            {/* Glow Effect */}
            ...
            <div className="relative flex gap-4">
                ...
                <div className="shrink-0 pt-1">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${isOpportunity ? 'bg-koni-gold/10 text-koni-gold' : 'bg-red-500/10 text-red-400'
                        }`}>
                ...
                <div className="flex-1 space-y-2">
                    <div className="flex items-start justify-between gap-4">
                        <h4 className={`text-sm font-medium ${isOpportunity ? 'text-koni-gold' : 'text-red-400'
                            }`}>
                    ...
                    {advice.action && (
                        <button
                            ...
                            className="mt-2 flex items-center gap-2 text-xs font-medium text-white/60 hover:text-white transition-colors group/btn"
                        >
