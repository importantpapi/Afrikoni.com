        ...
        <div className="space-y-6">
          ...
          <div className="p-4 bg-os-accent/10 rounded-lg border border-os-accent/20">
            <div className="flex items-center justify-between mb-2">
              <span className="text-os-sm font-medium text-afrikoni-deep">Current Trust Score</span>
              <Badge className={
          ...
          <div className="space-y-4">
            <h4 className="text-os-sm font-semibold text-afrikoni-chestnut">Trust Components</h4>
            {trustComponents.map((component, idx) => (
              <div key={idx}>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-os-xs text-afrikoni-deep/70">{component.label}</span>
                  <span className="text-os-xs font-medium text-afrikoni-chestnut">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-os-accent/20">
            <div className="text-center p-3 bg-afrikoni-cream rounded-lg">
              ...
              <div className="text-os-xs text-afrikoni-deep/70">Completed Deals</div>
            </div>
            <div className="text-center p-3 bg-afrikoni-cream rounded-lg">
              <div className="text-os-2xl font-bold text-afrikoni-chestnut">
                {trust.total_reviews || 0}
              </div>
              <div className="text-os-xs text-afrikoni-deep/70">Total Reviews</div>
            </div>
            {trust.avg_review_rating && (
              <div className="text-center p-3 bg-afrikoni-cream rounded-lg col-span-2">
                ...
                <div className="text-os-xs text-afrikoni-deep/70">Average Rating</div>
              </div>
            )}
          </div>
