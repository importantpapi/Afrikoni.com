...
export default function SellerHeader({
  ...
  return (
    <div className="flex h-full items-center justify-between px-6 gap-6">
      ...
      {/* RIGHT: Primary + Secondary CTAs + Notifications - Proper spacing */}
      <div className="flex items-center gap-3 flex-shrink-0">
        {/* SECONDARY: Add Product */}
        <Button
          onClick={() => navigate('/dashboard/products/new')}
          variant="outline"
          className="hidden md:flex items-center gap-2 border-afrikoni-gold/40 text-afrikoni-text-dark hover:bg-afrikoni-gold/10 hover:border-afrikoni-gold rounded-lg px-4 py-2 h-10 transition-all whitespace-nowrap"
        >
