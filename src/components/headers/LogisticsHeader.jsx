...
import { Menu, Search, Calendar, MessageSquare } from 'lucide-react';
import { Input } from '@/components/ui/input';
import NotificationBell from '@/components/notificationbell';

/**
 * Logistics dashboard header.
 * - Operations focused: search, time range, notifications, messages.
 * - No Add Product, RFQs, Marketplace, or Admin Mode.
 * - No community CTAs.
 */
