...
export const OS_Z_INDEX = {
    identityLayer: 1001, // Must be > systemLayer for dropdowns to overlap if needed
    systemLayer: 1000,
    modal: 900,
    dropdown: 800,
    workspaceNav: 710, // Must be > overlay (700) for mobile drawer
    overlay: 700,
    copilot: 720, // ✅ Bumped to be visible above overlays/nav
    content: 1
};
...
export default function OSShell({
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden">
            ...
            <div
                className="fixed left-0 right-0 overflow-hidden" // Added overflow-hidden to prevent blowout
                style={{
