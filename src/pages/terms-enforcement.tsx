...
export default function TermsEnforcement() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
      <ScrollToTop />
      <SEO
        title="Terms of Use & Enforcement Policy"
        description="Afrikoni Terms of Use & Enforcement Policy — formal rules, governance, and enforcement framework for using the Afrikoni Trade OS."
        url="/terms-enforcement"
      />
      <div className="min-h-screen bg-afrikoni-offwhite py-8 md:py-12">
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-8 text-gray-900 dark:text-gray-100">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 text-afrikoni-chestnut">
