...
export default function AntiCorruptionPolicy() {
  return (
    <>
      <SEO
        title="Anti-Corruption & Ethics Policy | Afrikoni B2B Marketplace"
        description="Afrikoni's zero-tolerance stance on bribery and corruption in African and global trade."
        url="/anti-corruption-policy"
      />
