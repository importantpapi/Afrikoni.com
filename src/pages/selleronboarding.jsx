      ...
      <div className="bg-gradient-to-br from-green-50 to-blue-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-afrikoni-deep max-w-3xl mx-auto mb-8">
            ...
            <div className="flex justify-center gap-4">
              <Link to={createPageUrl('Signup')}>
                <Button className="bg-green-600 hover:bg-green-700 text-afrikoni-creampx-8 py-6 text-lg">
                  Start Selling Now
                </Button>
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {features.map((feature, idx) => {
              ...
              return (
                <Card key={idx} className="border-afrikoni-gold/20 hover:shadow-lg transition bg-afrikoni-offwhite">
                  <CardContent className="p-6">
                    <div className={`w-16 h-16 ${feature.iconBg} rounded-xl flex items-center justify-center mb-4`}>
                      <Icon className={`w-8 h-8 ${feature.iconColor}`} />
                    </div>
                    <h3 className="font-bold text-afrikoni-chestnut text-xl mb-2">{feature.title}</h3>
                    <p className="text-afrikoni-deep text-sm">{feature.description}</p>
                  </CardContent>
                </Card>
              );
            })}
