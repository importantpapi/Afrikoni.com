    ...
    <>
      ...
      <div className="min-h-screen bg-afrikoni-offwhite py-8 md:py-12">
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-8 text-gray-900 dark:text-gray-100">
          ...
          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">1. What Are Cookies?</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">2. How We Use Cookies</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">3. Types of Cookies We Use</h2>
            
            <div className="space-y-4">
              <div>
                <h3 className="text-os-xl font-semibold text-afrikoni-chestnut mb-2">3.1 Necessary Cookies</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-os-xl font-semibold text-afrikoni-chestnut mb-2">3.2 Preference Cookies</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-os-xl font-semibold text-afrikoni-chestnut mb-2">3.3 Analytics Cookies</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-os-xl font-semibold text-afrikoni-chestnut mb-2">3.4 Marketing Cookies</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">4. Third-Party Cookies</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">5. Managing Your Cookie Preferences</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">6. Browser Settings</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4">
              <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-os-accent hover:underline">Google Chrome</a></li>
              <li><a href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences" target="_blank" rel="noopener noreferrer" className="text-os-accent hover:underline">Mozilla Firefox</a></li>
              <li><a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-os-accent hover:underline">Safari</a></li>
              <li><a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-os-accent hover:underline">Microsoft Edge</a></li>
            </ul>
          </section>

          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">7. Cookie Duration</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">8. Updates to This Policy</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-os-2xl md:text-3xl font-semibold text-afrikoni-chestnut">9. Contact Us</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
