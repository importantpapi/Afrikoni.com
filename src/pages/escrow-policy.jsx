    ...
    <>
      ...
      <div className="min-h-screen bg-afrikoni-offwhite">
        <div className="max-w-5xl mx-auto px-4 py-10 md:py-16">
          ...
          <p className="text-os-sm md:text-os-base text-afrikoni-deep/80 mb-6">
          ...
          <section className="bg-white rounded-os-sm border border-os-accent/20 p-5 md:p-6 space-y-4 mb-8">
            <h2 className="text-os-xl md:text-os-2xl font-semibold text-afrikoni-chestnut">
              1. When escrow protection applies
            </h2>
            <p className="text-os-sm md:text-os-base text-afrikoni-deep/80">
              Afrikoni Trade Shield™ applies when:
            </p>
            <ul className="list-disc list-inside text-os-sm md:text-os-base text-afrikoni-deep/80 space-y-1.5">
          ...
          <section className="bg-white rounded-os-sm border border-os-accent/20 p-5 md:p-6 space-y-4 mb-8">
            ...
            <ul className="list-decimal list-inside text-os-sm md:text-os-base text-afrikoni-deep/80 space-y-1.5">
            ...
            <p className="text-os-xs md:text-os-sm text-afrikoni-deep/70">
          ...
          <section className="bg-white rounded-os-sm border border-os-accent/20 p-5 md:p-6 space-y-3">
            <h2 className="text-os-xl md:text-os-2xl font-semibold text-afrikoni-chestnut">
