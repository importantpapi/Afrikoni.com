      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <Surface variant="panel" className="px-5 py-2.5 flex items-center gap-4 border-white/5 bg-white/[0.02]">
            <div className="flex items-center gap-2 text-emerald-600 text-os-xs font-medium">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {feePreview && (
            <div className="grid md:grid-cols-2 gap-6">
              <Surface variant="panel" className="p-8 group overflow-hidden relative">
                ...
                <div className="flex items-center gap-3 mb-8 border-b border-gray-100 pb-4">
                  ...
                  <h3 className="text-os-sm font-bold">Fee Summary</h3>
                </div>

                <div className="space-y-4 relative z-10">
                  {[
                    { label: 'Platform Fee', pct: '(5%)', val: feePreview.breakdown.escrow },
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-os-xs font-bold text-os-accent">Net Platform Yield</span>
              ...
              <Surface variant="panel" className="p-8 group overflow-hidden relative">
                ...
                <div className="flex items-center justify-between mb-8 border-b border-gray-100 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-os-sm font-bold">Currency Conversion</h3>
                  </div>
          ...
          {/* Transactions */}
          <Surface variant="panel" className="p-0 overflow-hidden">
            <div className="p-8 border-b border-gray-100 flex items-center justify-between">
              <div>
                <h3 className="text-os-xl font-black tracking-tight">Transaction History</h3>
                <p className="text-os-sm text-os-muted mt-1">Settlement and release log</p>
              </div>
                ...
                <tbody className="divide-y divide-white/5">
                  {transactions.map((tx) => (
                    <tr key={tx.id} className="hover:bg-white/[0.02] transition-colors group cursor-default">
                      ...
                      <td className="px-8 py-5">
                        <span className="text-os-xs font-medium border border-gray-200 px-2 py-1 rounded bg-gray-50 text-gray-600">
            ...
            {transactions.length === 0 && (
              <div className="py-20 text-center space-y-4">
                ...
                <p className="text-os-sm text-os-muted">No transactions yet.</p>
              </div>
            )}
          </Surface>
        </div>
