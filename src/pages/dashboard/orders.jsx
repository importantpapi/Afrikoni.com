...
const Orders = () => {
  ...
  if (loading) {
    return <div className="flex justify-center items-center min-h-[40vh] animate-pulse">
      <div className="flex flex-col items-center gap-2">
        <div className="w-8 h-8 border-2 border-koni-gold/30 border-t-koni-gold rounded-full animate-spin" />
        <span className="text-xs text-os-muted uppercase tracking-wider">Accessing Trade Kernel...</span>
      </div>
    </div>;
  }
