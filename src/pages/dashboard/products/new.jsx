    ...
    try {
      ...
      if (result) {
        setFormData((prev) => ({
          ...
          short_description: prev.short_description || result.short_description || '',
          description:
            result.full_description ||
            prev.description ||
            'Full description generated by Afrikoni AI. Please review and adjust to match your real product.',
        }));
        toast.success('Afrikoni AI generated a product description. Please review before publishing.');
      }
    } catch (error) {
      // non-blocking
