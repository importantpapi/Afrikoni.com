              ...
              <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                <div className="flex items-center gap-6">
                  <div className="relative">
                    <div className="absolute inset-0 bg-os-accent/20 blur-xl rounded-os-md" />
                    <div className="relative rounded-os-md border border-os-accent/30 bg-black/40 p-4 backdrop-blur-xl">
                      <Settings className="h-8 w-8 text-os-accent" />
                    </div>
                  </div>
                  <div>
                  ...
                  {[
                    ...
                    <div key={tag.label} className={cn(
                      ...
                      tag.color === 'emerald' ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" :
                        tag.color === 'os-accent' ? "bg-os-accent/10 border-os-accent/20 text-os-accent" :
                          "bg-os-blue/10 border-os-blue/20 text-blue-400"
                    )}>
                      <div className={cn("w-1 h-1 rounded-full animate-pulse",
                        tag.color === 'emerald' ? "bg-emerald-400" :
                          tag.color === 'os-accent' ? "bg-os-accent" :
                            "bg-blue-400"
                      )} />
                      {tag.label}
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                      ...
                      {avatarUrl && (
                        <Button
                          ...
                          className="h-12 px-6 text-red-400/60 hover:text-red-400 hover:bg-red-400/5 font-bold uppercase tracking-widest text-os-xs"
                        >
                ...
                <div className="space-y-4 pt-4 border-t border-gray-100">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <Button
                      ...
                      disabled={isSaving}
                      className="h-14 px-12 bg-os-accent hover:bg-os-accent/80 text-black font-black uppercase tracking-widest rounded-os-md shadow-[0_12px_44px_-8px_rgba(212,175,55,0.4)] transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
                    >
                      {isSaving ? (
                        <>
          ...
          <TabsContent value="company" className="space-y-6">
            <Surface variant="glass" className="overflow-hidden p-0 rounded-[2rem] border border-gray-200 shadow-xl bg-white/60 backdrop-blur-3xl">
              ...
              <div className="p-8 md:p-12 space-y-12">
                  ...
                  <div className="grid md:grid-cols-3 gap-10">
                    ...
                    <div className="space-y-4">
                      ...
                      <Input
                        ...
                        className="h-14 bg-white/5 border-white/10 rounded-os-md"
                      />
                    </div>
                ...
                {/* Trust Gate Link */}
                <div className="p-8 rounded-[2rem] border border-os-blue/20 bg-blue-500/5 group hover:bg-os-blue/10 transition-all duration-500">
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    <div className="p-5 rounded-os-md bg-blue-500/20 text-blue-400 border border-blue-500/30">
          ...
          <TabsContent value="role" className="space-y-6">
            <Surface variant="glass" className="overflow-hidden p-0 rounded-[2rem] border border-gray-200 shadow-xl bg-white/60 backdrop-blur-3xl">
              ...
              <div className="p-8 md:p-12 space-y-12">
                  ...
                  <div className="relative flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
                    <div className="text-center md:text-left">
                      <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                        <span className="text-os-xs font-black uppercase tracking-[0.4em] text-os-accent">Active Persona</span>
                        {isSystemReady ? (
                          <span className="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-500 text-os-xs font-black border border-emerald-500/20 flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                            NETWORK LIVE
                          </span>
                        ) : (
                          <span className="px-3 py-1 rounded-full bg-amber-500/10 text-amber-500 text-os-xs font-black border border-amber-500/20">
                            OFFLINE SYNC
                          </span>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      {[
                        ...
                        <button
                          ...
                          className={`
                            ...
                            ${preferences.default_mode === role.id
                              ? 'bg-os-accent text-black border-os-accent shadow-[0_20px_50px_rgba(212,175,55,0.3)] scale-[1.05] z-10'
                        ...
                        >
                          ...
                          <span className="text-os-xs font-black uppercase tracking-widest truncate w-full text-center">{role.label}</span>
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                      ...
                      <div key={cap.id} className={cn(
                        ...
                        cap.active
                          ? "bg-white/[0.03] border-white/10 hover:border-os-accent/30 shadow-os-md"
                          : "bg-black/20 border-transparent opacity-20 grayscale"
                      )}>
                        <div className={cn(
                          "p-3 rounded-os-md transition-all duration-500",
                          cap.active ? "bg-os-accent/10 text-os-accent group-hover:bg-os-accent group-hover:text-black" : "bg-white/5 text-white/20"
                        )}>
                ...
                {/* Pro Callout */}
                <div className="p-8 rounded-[2.5rem] bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-os-blue/20 flex flex-col md:flex-row items-center justify-between gap-8">
                  ...
                  {[
                    ...
                    <div key={item.key} className="flex items-center justify-between p-6 rounded-os-md border border-white/5 bg-white/[0.03] group hover:bg-white/[0.05] transition-all duration-300">
                      <div className="flex items-center gap-5">
                        <div className="p-3 rounded-os-sm bg-white/5 text-white/40 group-hover:text-os-accent group-hover:bg-os-accent/10 transition-all duration-500">
                      ...
                      <Switch
                        ...
                        className="data-[state=checked]:bg-os-accent scale-125"
                      />
                    </div>
                  ))}
                </div>
                    ...
                    <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.03] space-y-4">
                      ...
                      <div className="relative group">
                        <Input
                          ...
                          readOnly
                          className="h-12 font-mono bg-black/60 border-white/5 rounded-os-sm text-os-accent text-center tracking-widest"
                        />
                      </div>
