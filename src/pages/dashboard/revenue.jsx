    ...
    return (
        <div className="os-page os-stagger space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-[var(--os-text-primary)]">Sovereign Treasury</h1>
                    <p className="text-sm text-[var(--os-text-secondary)]">Real-time visualization of protocol cash flow.</p>
                </div>
                <div className="px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-lg flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                    <span className="text-sm font-mono text-emerald-400">PROTOCOL SOLVENT</span>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
                <Surface variant="glass" className="p-5">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-sm text-[var(--os-text-secondary)]">Total Revenue (YTD)</span>
                    </div>
                ...
                <Surface variant="glass" className="p-5">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-sm text-[var(--os-text-secondary)]">Avg. Take Rate</span>
                    </div>
                    <div className="text-2xl font-bold text-[var(--os-text-primary)]">
                ...
                <Surface variant="glass" className="p-5">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-sm text-[var(--os-text-secondary)]">FX Spread Yield</span>
                    </div>
                    <div className="text-2xl font-bold text-[var(--os-text-primary)]">
                        1.2%
                    </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <Surface variant="glass" className="md:col-span-2 p-6">
                    <h2 className="text-lg font-semibold text-[var(--os-text-primary)] mb-6">Revenue Composition</h2>
                ...
                <div className="space-y-6">
                    <Surface variant="glass" className="p-6 h-full">
                        <h2 className="text-lg font-semibold text-[var(--os-text-primary)] mb-4">Revenue Streams</h2>
                        <div className="space-y-4">
                            <div className="p-3 bg-white/5 rounded-lg flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-2 h-2 rounded-full bg-amber-500"></div>
                                    <span className="text-sm text-gray-300">Escrow Fees</span>
                                </div>
                            ...
                            <div className="p-3 bg-white/5 rounded-lg flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm text-gray-300">FX Spread</span>
                                </div>
                            ...
                            <div className="p-3 bg-white/5 rounded-lg flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm text-gray-300">Logistics Markup</span>
                                </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10">
                            <h3 className="text-sm font-semibold text-gray-400 mb-3 uppercase tracking-wider">Active Monetization</h3>
